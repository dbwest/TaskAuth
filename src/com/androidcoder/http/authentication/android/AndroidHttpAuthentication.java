/**
   ...
   Copyright 2010 androidcoder.org
...
public class AndroidHttpAuthentication extends Activity {

    private static final int    TIMEOUT    = 20000;
    private static final String mIpAddress = "www.taskforceapp.com";
    private static final int    mPort      = 443;
    		//443;
    private static final String mSubPage   = "api/v1/user.json";                    // "blog/android-http-request-basic-authentication";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
            	 //retrievePage();
            	//R.string.ContentView = retrievePage();
            	//setContentView(R.string.ContentView);
            	//httpsConnect();
            	String readTaskForce = readTaskForce();

//            	  try {
//          			JSONArray jsonArray = new JSONArray(readTaskForce);
//          			Log.i(AndroidHttpAuthentication.class.getName(),
//          					"Number of entries " + jsonArray.length());
//          			for (int i = 0; i < jsonArray.length(); i++) {
//          				JSONObject jsonObject = jsonArray.getJSONObject(i);
//          				Log.i(AndroidHttpAuthentication.class.getName(), jsonObject.getString("text"));
//          			}
          			try {
              			String jsonArray = new String(readTaskForce);
              			//Log.i(AndroidHttpAuthentication.class.getName(),
//              					"Number of entries " + jsonArray.length());
//              			for (int i = 0; i < jsonArray.length(); i++) {
//              				JSONObject jsonObject = jsonArray.getJSONObject(i);
//              				Log.i(AndroidHttpAuthentication.class.getName(), jsonObject.getString("text"));
//              			}
              			Log.i(AndroidHttpAuthentication.class.getName(), jsonArray);
          		} catch (Exception e) {
          			e.printStackTrace();
          		}
    ...
    private void httpsConnect (){
        ...
        //
        HttpPost put = new HttpPost("https://www.taskforceapp.com/api/v1/user.json");
//        try {
...
//        }
    ...
    private void retrievePage() {
        ...
        try {
            ...
            URL url = new URL(String.format("https://%s:%d/%s", mIpAddress, mPort, mSubPage));
            ...
            conn.setRequestProperty(
            	       "Authorization",
            	       "basic " +  Base64.encode("david.b.west@gmail.com:29ef533ef18c".getBytes(),
            	                                 Base64.DEFAULT)
            	      );
...
//                    return new PasswordAuthentication("david.b.west@gmail.com", "29ef533ef18c".toCharArray());
//                }
//            });
            ...
            //s.log(conn.getResponseCode());
            //Log.d(LOG_TAG, conn.getResponseCode());
            //(LOG_TAG, conn.getResponseCode());
